...
const createRow = (contato, index) => {
  ...
  newRow.innerHTML = `
          ...
          <td>
           <button type="button" class="button green editar" uk-tooltip="title: Editar contato" id="editar-${index}"></button>
            <button type="button" class="button red excluir" uk-tooltip="title: Excluir contato" id="excluir-${index}"></button>
          </td> 
          `;
  // inseri no html
